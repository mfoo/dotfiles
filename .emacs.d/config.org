...
I also turn on emojis. I rarely use this but sometimes a sad face is necessary.

#+BEGIN_SRC emacs-lisp
;(use-package :emojify
;  :ensure t
;  :config (add-hook 'org-mode-hook (lambda () (emojify-mode)))
;)
#+END_SRC
...
sense. It would be nice to only do this for modes that are used when editing text. Is there something I can hook into to
improve this?
