...
I've made some changes using custom-set-faces and they've probably crept into =~/.emacs=.
...
Highlighting colours for whitespace
...
(defun mfoot-append-google-analytics-tag (template info)
  ...
  (let ((html-template (org-html-template template info)))
    (let ((pos (string-match (regexp-quote "</body>") html-template)))
      (concat (substring html-template 0 (+ 7 pos))
...
(defun mfoot-export-emacs-config-to-file
  ...
  (let* ((extension (concat "." org-html-extension))
   ...
   (org-publish-org-to 'mfoot-html-with-google-analytics filename ".html" plist pub-dir)))
...
(use-package ox-reveal
  ...
  :defer t
  :config
  (setq org-reveal-root (concat user-emacs-directory "org-reveal/reveal.js"))
